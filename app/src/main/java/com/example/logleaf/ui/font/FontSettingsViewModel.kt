...
package com.example.logleaf.ui.font // あなたのパッケージ名に合わせてください
...
class FontSettingsViewModel(
    ...
    private val fontTemplates = listOf(
        ...
        AppFont(name = "M PLUS 1", fontWeight = FontWeight.Normal, sourceType = FontSourceType.Internal(
            R.font.m_plus_1
        ), status = FontStatus.INTERNAL),
        AppFont(name = "Noto Sans JP", fontWeight = FontWeight.Bold, sourceType = FontSourceType.Internal(
            R.font.noto_sans_jp
        ), status = FontStatus.INTERNAL),
